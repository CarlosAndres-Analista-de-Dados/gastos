...
- **Três visões dos registros:**
  ...
  - **Relatório:** compara o mês (ou a semana) atual com o anterior e gera dicas automáticas, incluindo projeção de fechamento do mês.
...
```js
const CACHE_NAME = "meus-gastos-cache-v5"; // troque para v6, v7...
```
